          ...
          <>
            <div className="grid grid-cols-3 gap-4 mb-8">
              <div className="bg-white border rounded-xl p-4">
                ...
                <div className="text-2xl font-semibold">{goals.length} / 8</div>
              </div>
              <div className="bg-white border rounded-xl p-4">
                <div className="text-sm text-gray-500 mb-1">Total weightage</div>
                  ...
                  <div key={goal.id} className="bg-white border rounded-xl p-5 hover:shadow-sm transition-shadow">
                    ...
                    {goal.status === 'returned' && (
                      <div className="mt-3 pt-3 border-t flex items-center gap-2">
                        ...
                        <p className="text-sm text-red-500">Returned for rework by your manager. Please revise and resubmit.</p>
                      </div>
                    )}
  ...
  return (
    <div className="mt-3 pt-3 border-t flex items-center gap-3">
      ...
      <button onClick={save} disabled={saving}
        className="bg-blue-600 text-white px-3 py-1 rounded-lg text-xs font-medium hover:bg-blue-700 disabled:opacity-50 transition-colors">
